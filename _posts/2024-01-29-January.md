...
with [work by David Heidelberg](https://github.com/minetest/minetest/pull/14075) to switch between the two while playing marks
...
their favorite submissions on the new [Game Jam Site](https://jam.luanti.org), the winners emerged.
