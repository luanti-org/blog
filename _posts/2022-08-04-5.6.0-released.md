...
[our website](https://www.luanti.org/downloads/).
Also check out
[the full changelog](https://dev.luanti.org/Changelog#5.5.0_.E2.86.92_5.6.0).
...
Read [the full changelog](https://dev.luanti.org/Changelog#5.5.0_.E2.86.92_5.6.0).
...
- Linux: [Flatpak](https://flathub.org/apps/details/net.minetest.Minetest).
  See [downloads page](https://www.luanti.org/downloads/) for more options
