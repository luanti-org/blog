...
Luanti ([formerly Minetest](/2024/10/13/Introducing-Our-New-Name/)) 5.10.0 has been released
...
found [here](https://dev.luanti.org/Changelog#5.9.1_.E2.86.92_5.10.0).
...
Check out [the full changelog](https://dev.luanti.org/Changelog#5.9.1_.E2.86.92_5.10.0) for other minor features and
